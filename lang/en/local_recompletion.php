...
$string['lessonattempts_help'] = 'Should lesson attempts be deleted?';
$string['lessonattempts'] = 'Delete lesson attempts';
$string['archivelesson'] = 'Archive lesson attempts';
$string['archivelesson_help'] = 'Should lesson attempts be archived?';
